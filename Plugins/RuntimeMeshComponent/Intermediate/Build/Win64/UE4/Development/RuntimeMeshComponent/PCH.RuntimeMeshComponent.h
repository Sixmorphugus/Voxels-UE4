...
#define PROJECT_PRODUCT_IDENTIFIER SuperAlchemist
#define NDEBUG 1
#define UE_BUILD_DEVELOPMENT 1
#define UE_ENGINE_DIRECTORY ../../../../More Program Files/Epic Games/UE_4.15/Engine/
#define UE_PROJECT_NAME SuperAlchemist
#define ORIGINAL_FILE_NAME "UE4-RuntimeMeshComponent.lib"
